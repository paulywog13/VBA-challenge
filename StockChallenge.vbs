...
' Define Headers and Challenge Value Titles for Summary Tables
...
' Assigning Greatest Volume and Percent Changes to Challenge Summary Table
 ...
 ' Loop Function for Challenge Table
       For j = 2 To LastRow
       
  ' Identifying Greatest Percent Increase/Decrease and Greatest Total Volume for Challenge Table
